...
db.products.find().forEach(function(prod){print("Product Name:",prod.product_name,',',
"Product Material:",prod.product_material)})
...
db.products
  .aggregate([
    ...
    db.products.remove({ product_price: prod._id })
  });
